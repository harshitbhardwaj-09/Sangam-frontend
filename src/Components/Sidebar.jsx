...
//           <Link 
//             to="/projectdetails" 
//             className={`flex items-center gap-4 p-4 transition-colors ${location.pathname === '/projectdetails' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
//           >
//             <BiBookAlt className="text-2xl" />
...
//             className={`flex items-center gap-4 p-4 transition-colors ${location.pathname === '/projectmanagement' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
//           >
...
//           <Link 
//             to="/resources" 
//             className={`flex items-center gap-4 p-4 transition-colors ${location.pathname === '/resources' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
//           >
...
//           <Link 
//             to="/training" 
//             className={`flex items-center gap-4 p-4 transition-colors ${location.pathname === '/training' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
//           >
...
//             className={`flex items-center gap-4 p-4 transition-colors ${location.pathname === '/discussion' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
//           >
...
//           <Link 
//             to="/BidSystem" 
//             className={`flex items-center gap-4 p-4 transition-colors ${location.pathname === '/BidSystem' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
//           >
//             <BiCurrentLocation className="text-2xl" />
...
//           <Link 
//             to="/Bidding" 
//             className={`flex items-center gap-4 p-4 transition-colors ${location.pathname === '/Bidding' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
//           >
//             <BiCurrentLocation className="text-2xl" />
...
//           <Link 
//             to="/logout" 
//             className={`flex items-center gap-4 p-4 transition-colors ${location.pathname === '/logout' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
//           >
