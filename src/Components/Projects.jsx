...
function Projects() {
  ...
  return (
    <div className="bg-[#101114] min-h-screen p-8 text-gray-100">
      ...
      <section>
        <ProjectSection title="Ongoing Projects" projects={categorizedProjects("Ongoing")} handleViewProject={handleViewProject} />
        <ProjectSection title="Completed Projects" projects={categorizedProjects("Completed")} handleViewProject={handleViewProject} />
        <ProjectSection title="Pending Projects" projects={categorizedProjects("Pending")} handleViewProject={handleViewProject} />
      </section>
