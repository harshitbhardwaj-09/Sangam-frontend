    ...
    <div className="flex">
      ...
      >
        ...
        <div className="mt-8 overflow-y-auto">
          ...
          <Link 
            to="/department" 
            className={`flex items-center gap-4 p-5 transition-colors ${location.pathname === '/department' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
          >
            <BiCurrentLocation className="text-2xl" />
          ...
          <Link 
            to="/costreduction" 
            className={`flex items-center gap-4 p-5 transition-colors ${location.pathname === '/costreduction' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
          >
            <BiCurrentLocation className="text-2xl" />
          ...
          <Link 
            ...
            className={`flex items-center gap-4 p-5 transition-colors ${location.pathname === '/loginn' ? 'bg-gray-700 text-yellow-500' : 'text-white hover:bg-gray-700'}`}
          >
